...
func RegisterRouter(r *gin.Engine) {
	...
	authGroup.Use(auth.JWTAuthMiddleware())
	{
		...
		authGroup.POST("/server/start", startServerProcess)
		authGroup.POST("/server/stop", stopServerProcess)
		...
		authGroup.POST("/rcon/direct", sendDirectRcon)
		...
		authGroup.GET("/save/export", exportSave)
		authGroup.POST("/save/import", importSave)
	}
}
