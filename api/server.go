...
//	@Description	Start the PalWorld server process on the host
//	@Tags			Server
//	@Accept			json
//	@Produce		json
//	@Security		ApiKeyAuth
...
func startServerProcess(c *gin.Context) {
	if err := tool.StartServer(); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
	c.JSON(http.StatusOK, gin.H{"success": true})
...
// stopServerProcess godoc
//
//	@Summary		Stop Server Process
//	@Description	Stop the PalWorld server process on the host
//	@Tags			Server
//	@Accept			json
//	@Produce		json
//	@Security		ApiKeyAuth
...
func stopServerProcess(c *gin.Context) {
...
//
//	@Summary		Get Server Process Status
//	@Description	Check if the PalWorld server process is running
//	@Tags			Server
//	@Accept			json
//	@Produce		json
